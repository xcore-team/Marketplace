...
from .routes import admin_router, categories_router, services_router, submissions_router
...
class Plugin(AutoDispatchMixin, TrustedBase):
    async def on_load(self) -> None:
        ...
        self.app.include_router(service_github_router(db, events, secret_key))
        self.app.include_router(admin_router(db))

        logger.info("[xservices] Prêt — /categories  /services  /submissions  /github  /admin")
